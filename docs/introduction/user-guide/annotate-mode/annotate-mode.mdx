...
import annotatemodeswitcher from "./img/annotate-mode-switcher.png";
import annotatemode from "./img/annotate-mode.png";
import areacolors from "./img/area-colors.png";
import areaexample1 from "./img/area-example1.png";
import areaexample2 from "./img/area-example2.png";
import areasnap from "./img/area-snap.png";
import areastyleexample1 from "./img/area-style-example1.png";
import areastyle from "./img/area-style.png";
import areathickness from "./img/area-thickness.png";
import area from "./img/area.png";
import arrowexample1 from "./img/arrow-example1.png";
import arrowexample2 from "./img/arrow-example2.png";
import arrow from "./img/arrow.png";
import calloutexample1 from "./img/callout-example1.png";
import calloutexample2 from "./img/callout-example2.png";
import callout from "./img/callout.png";
import cloudexample from "./img/cloud-example.png";
import cloud from "./img/cloud.png";
import color from "./img/color.png";
import countcolors from "./img/count-colors.png";
import countexample1 from "./img/count-example1.png";
import countexample2 from "./img/count-example2.png";
import countname from "./img/count-name.png";
import countname2 from "./img/count-name2.png";
import countsave from "./img/count-save.png";
import countsave2 from "./img/count-save2.png";
import countvalue from "./img/count-value.png";
import countvalue2 from "./img/count-value2.png";
import count from "./img/count.png";
import ellipseexample1 from "./img/ellipse-example1.png";
import ellipse from "./img/ellipse.png";
import eraseexample1 from "./img/erase-example1.png";
import eraseexample2 from "./img/erase-example2.png";
import eraseexample3 from "./img/erase-example3.png";
import erase from "./img/erase.png";
import fillbothendsexample1 from "./img/fill-both-ends-example1.png";
import fillbothends from "./img/fill-both-ends.png";
import fillsingleendexample1 from "./img/fill-single-end-example1.png";
import fillsingleend from "./img/fill-single-end.png";
import fontsize from "./img/font-size.png";
import fontstyle from "./img/font-style.png";
import font from "./img/font.png";
import freehandexample1 from "./img/freehand-example1.png";
import freehandexample2 from "./img/freehand-example2.png";
import freehand from "./img/freehand.png";
import highlighterexample1 from "./img/highlighter-example1.png";
import highlighterexample2 from "./img/highlighter-example2.png";
import highlighter from "./img/highlighter.png";
import lengthcolors from "./img/length-colors.png";
import lengthexample1 from "./img/length-example1.png";
import lengthexample2 from "./img/length-example2.png";
import length from "./img/length.png";
import lockmarkups from "./img/lock-markups.png";
import measureexample1 from "./img/measure-example1.png";
import measureexample2 from "./img/measure-example2.png";
import measuretype from "./img/measure-type.png";
import measure from "./img/measure.png";
import note from "./img/note.png";
import opacity from "./img/opacity.png";
import openbothendsexample1 from "./img/open-both-ends-example1.png";
import openbothends from "./img/open-both-ends.png";
import opensingleendexample1 from "./img/open-single-end-example1.png";
import opensingleend from "./img/open-single-end.png";
import paintexample1 from "./img/paint-example1.png";
import paintexample2 from "./img/paint-example2.png";
import paint from "./img/paint.png";
import pathexample1 from "./img/path-example1.png";
import path from "./img/path.png";
import polygonexample from "./img/polygon-example.png";
import polygon from "./img/polygon.png";
import polylineexample1 from "./img/polyline-example1.png";
import polylineexample2 from "./img/polyline-example2.png";
import polyline from "./img/polyline.png";
import rectangleexample1 from "./img/rectangle-example1.png";
import rectangle from "./img/rectangle.png";
import redo from "./img/redo.png";
import roundedrectangleexample from "./img/rounded-rectangle-example.png";
import roundedrectangle from "./img/rounded-rectangle.png";
import savesuccess from "./img/save-success.png";
import save from "./img/save.png";
import shapesexample1 from "./img/shapes-example1.png";
import shapesexample2 from "./img/shapes-example2.png";
import shapes from "./img/shapes.png";
import snap from "./img/snap.png";
import stampexample1 from "./img/stamp-example1.png";
import stampexample2 from "./img/stamp-example2.png";
import stampexample3 from "./img/stamp-example3.png";
import stamp from "./img/stamp.png";
import textexample1 from "./img/text-example1.png";
import textexample2 from "./img/text-example2.png";
import textstyleaccordian from "./img/text-style-accordian.png";
...
Provides an eraser tool for visually removing annotations or parts of annotations. The erase tool creates the drawing using the background color of the current viewed document, which covers the content of the other drawings.
<img  src={eraseexample1} alt="eraseexample1" />

Once the erase tool is selected, a user can start drawing the figure with the mouse. One is not limited in terms of number of clicks and interactions and can continue creation of the erase markup until the “Erase” tool is deselected in the annotate toolbar.
<img  src={eraseexample2} alt="eraseexample2" />

When a user deselects the erase tool, respective markup will get created and a user will be able to interact with it and move the markup. Also, the thickness modal will appear, where a user will be able to change the thickness of the erase markup created in a range of 1-12pt.
<img  src={eraseexample3} alt="eraseexample3" />

When the erase annotation is saved a user can get access to viewing and editing its properties.
