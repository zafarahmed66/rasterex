...
The arrow annotation editing interface differs from the typical modal used for most annotation types. Instead, it appears directly adjacent to the arrow markup, simplifying the modification process. The interface is subdivided into four sections that allow users to view and manage various properties of the arrow annotation:
