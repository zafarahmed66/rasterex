...
- **Current Functionality**: Clicking on the logo does not currently initiate any navigation action.
- **Future Implementation**: The design includes provisions to direct users either to the root system or a designated website upon clicking the logo, enhancing user experience and enabling seamless navigation.
...
2. **Save**
   ...
   - Triggers the saving of the currently open file.
...
- **Feedback**: After successfully saving the markup layer, users are presented with a confirmation message:  
  ...
  This message provides feedback and reassurance regarding the status of their annotations.
